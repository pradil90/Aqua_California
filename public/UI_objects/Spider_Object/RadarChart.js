...
d3.select("#PDSI").attr("x",230);
d3.select("#PDSI").attr("y",-5);
  ...
  d.forEach(function(y, x){
    ...
    g.selectAll(".area")
           ...
           //.style("stroke-dasharray", ("10,0")) // make the stroke dashed
           //.style("stroke-dasharray", (lineformatter)) // make the stroke dashed
